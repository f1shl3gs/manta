...
require (
	...
	github.com/dgraph-io/badger/v2 v2.2007.3-0.20200927102853-5e3d4b9926a7 // indirect
	github.com/dgraph-io/dgo/v2 v2.1.1-0.20191127085444-c7a02678e8a6 // indirect
