...
func TestStorageTerm(t *testing.T) {
	...
	dir, err := os.MkdirTemp("", "rafttest")
	require.NoError(t, err)
	defer os.RemoveAll(dir)

	ds, err := Init(dir, logger)
...
func TestStorageFirstIndex(t *testing.T) {
	...
	ds, err := Init(dir, zaptest.NewLogger(t))
	assert.NoError(t, err)
...
func TestMetaFile(t *testing.T) {
	dir, err := os.MkdirTemp("", "rafttest-meta")
	require.NoError(t, err)
...
func TestEntryFile(t *testing.T) {
	...
	require.NoError(t, err)
	el, err := openWal(dir, zaptest.NewLogger(t))
	require.NoError(t, err)
...
func TestStorageBig(t *testing.T) {
	...
	files, err := getLogFiles(dir, logger)
	require.NoError(t, err)
