...
export const PROMQL_FUNCTIONS: PromqlFunction[] = [
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        type: 'scalar',
        desc:
          'The lower sf the more importance of old data, sf must be between 0 and 1',
      },
      {
        name: 'tf',
        type: 'scalar',
        desc:
          'The higher the more trends is considered, tf must be between 0 and 1',
      },
    ],
    desc:
  ...
  },
  {
    ...
    desc:
      'sort(v instant-vector) returns vector elements sorted by their sample values, in descending order.',
    example: '',
    link:
