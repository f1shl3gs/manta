...
export class UnthemedVirtualizedTraceView extends React.Component<VirtualizedTraceViewProps> {
  ...
  constructor(props: VirtualizedTraceViewProps) {
    ...
    this.rowStates = generateRowStates(
      trace.spans,
      childrenHiddenIDs,
      detailStates
    )
  ...
  shouldComponentUpdate(nextProps: VirtualizedTraceViewProps) {
    ...
    const nextPropKeys = Object.keys(nextProps) as Array<
      keyof VirtualizedTraceViewProps
    >
  ...
  componentWillUpdate(nextProps: VirtualizedTraceViewProps) {
    ...
    if (
      ...
      this.rowStates = nextTrace
        ? generateRowStates(nextTrace.spans, nextHiddenIDs, nextDetailStates)
        : []
    }
    if (
      currentViewRangeTime !== nextViewRangeTime ||
      (trace !== nextTrace && nextTrace)
    ) {
